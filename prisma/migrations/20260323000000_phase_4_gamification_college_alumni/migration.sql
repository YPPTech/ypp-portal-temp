...
ALTER TABLE "Mentorship"
    ...
    ADD COLUMN "longestReflectionStreak" INTEGER NOT NULL DEFAULT 0,
...
-- CreateEnum
CREATE TYPE "KudosCategory" AS ENUM ('HELPFULNESS', 'LEADERSHIP', 'CREATIVITY', 'ABOVE_AND_BEYOND', 'TEAMWORK', 'PROBLEM_SOLVING');
...
-- AddForeignKey
ALTER TABLE "PeerKudos" ADD CONSTRAINT "PeerKudos_giverId_fkey" FOREIGN KEY ("giverId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PeerKudos" ADD CONSTRAINT "PeerKudos_receiverId_fkey" FOREIGN KEY ("receiverId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- CreateEnum
CREATE TYPE "CollegeStage" AS ENUM ('EXPLORING', 'BUILDING_PROFILE', 'TEST_PREP', 'COLLEGE_LIST', 'APPLICATIONS', 'FINANCIAL_AID', 'DECISION', 'TRANSITION');
...
-- AddForeignKey
ALTER TABLE "CollegeReadinessRoadmap" ADD CONSTRAINT "CollegeReadinessRoadmap_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CollegeRoadmapTask" ADD CONSTRAINT "CollegeRoadmapTask_roadmapId_fkey" FOREIGN KEY ("roadmapId") REFERENCES "CollegeReadinessRoadmap"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- CreateEnum
CREATE TYPE "ActivityCategory" AS ENUM ('LEADERSHIP', 'COMMUNITY_SERVICE', 'ATHLETICS', 'ARTS_CREATIVE', 'ACADEMIC', 'WORK_INTERNSHIP', 'PERSONAL_PROJECT', 'STEM', 'OTHER');
...
-- AddForeignKey
ALTER TABLE "CollegeActivity" ADD CONSTRAINT "CollegeActivity_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ActivityMilestone" ADD CONSTRAINT "ActivityMilestone_activityId_fkey" FOREIGN KEY ("activityId") REFERENCES "CollegeActivity"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AlumniPanelist" ADD CONSTRAINT "AlumniPanelist_eventId_fkey" FOREIGN KEY ("eventId") REFERENCES "AlumniPanelEvent"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AlumniPanelist" ADD CONSTRAINT "AlumniPanelist_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AlumniPanelRsvp" ADD CONSTRAINT "AlumniPanelRsvp_eventId_fkey" FOREIGN KEY ("eventId") REFERENCES "AlumniPanelEvent"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AlumniPanelRsvp" ADD CONSTRAINT "AlumniPanelRsvp_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AlumniIntroRequest" ADD CONSTRAINT "AlumniIntroRequest_requesterId_fkey" FOREIGN KEY ("requesterId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AlumniIntroRequest" ADD CONSTRAINT "AlumniIntroRequest_alumniId_fkey" FOREIGN KEY ("alumniId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
